export const proyectos = [
  {
    ...
    dificultad: 'alta',
    tareas: [
      { id: 1, nombre: 'Definir', avance: 100 },
      { id: 2, nombre: 'Base de datos', avance: 60 },
      { id: 3, nombre: 'Backend', avance: 0 },
  ...
  },
  {
    ...
    dificultad: 'media',
    tareas: [
      { id: 1, nombre: 'UI/UX', avance: 100 },
      { id: 2, nombre: 'Carrito', avance: 45 },
      { id: 3, nombre: 'Pasarela', avance: 20 },
